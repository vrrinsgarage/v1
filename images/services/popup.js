...
(() => {
  ...
  // Path gambar layanan: gunakan ID layanan sebagai nama file.
  // Lima layanan berikut dikunci ke nama file yang sudah disepakati;
  // layanan lain tetap menggunakan pola lama sehingga gambar lama tidak terganggu.
  const SERVICE_IMAGE_MAP = {
    'over-houl-engine': 'images/services/over-houl-engine.webp',
    'ganti-rack-end-long-tie-rod': 'images/services/ganti-rack-end-long-tie-rod.webp',
    'ganti-flexible-hose-minyak-rem': 'images/services/ganti-flexible-hose-minyak-rem.webp',
    'ganti-disc-brake-1-sisi': 'images/services/ganti-disc-brake-1-sisi.webp',
    'ganti-kabel-busi': 'images/services/ganti-kabel-busi.webp'
  };

  const serviceImage = (id) =>
    SERVICE_IMAGE_MAP[id] || `images/services/${id}.webp`;
